...
let needBeep = false;
let firstTIError = null;
let secondTIError = null;
let thirdTIError = null;
let fourthTIError = null;
...
function updateAlerts(){
    if(needShowFirstTIError && firstTIError){
        ...
        $("#markerTI1").removeClass("normal")
        $("#markerTI1").removeClass("noData")
        $("#markerTI1").addClass("danger")
    }
    if(needShowSecondTIError && secondTIError){
        //$("#ti2_ok").addClass('hidden');
        //$("#ti2_error").removeClass('hidden');
        $("#markerTI2").removeClass("normal")
        $("#markerTI2").removeClass("noData")
        $("#markerTI2").addClass("danger")
    }
    if(needShowThirdTIError && thirdTIError){
        //$("#ti3_ok").addClass('hidden');
        //$("#ti3_error").removeClass('hidden');
        $("#markerTI3").removeClass("normal")
        $("#markerTI3").removeClass("noData")
        $("#markerTI3").addClass("danger")
    }
    if(needShowFourthTIError && fourthTIError){
        //$("#ti4_ok").addClass('hidden');
        //$("#ti4_error").removeClass('hidden');
        $("#markerTI4").removeClass("normal")
        $("#markerTI4").removeClass("noData")
        $("#markerTI4").addClass("danger")
    }
    ...
    if(needShowFirstTIError && !firstTIError){
        ...
        $("#markerTI1").removeClass("danger")
        $("#markerTI1").removeClass("noData")
        $("#markerTI1").addClass("normal")
    }
    if(needShowSecondTIError && !secondTIError){
        //$("#ti2_error").addClass('hidden');
        //$("#ti2_ok").removeClass('hidden');
        $("#markerTI2").removeClass("danger")
        $("#markerTI2").removeClass("noData")
        $("#markerTI2").addClass("normal")
    }
    if(needShowThirdTIError && !thirdTIError){
        //$("#ti3_error").addClass('hidden');
        //$("#ti3_ok").removeClass('hidden');
        $("#markerTI3").removeClass("danger")
        $("#markerTI3").removeClass("noData")
        $("#markerTI3").addClass("normal")
    }
    if(needShowFourthTIError && !fourthTIError){
        //$("#ti4_error").addClass('hidden');
        //$("#ti4_ok").removeClass('hidden');
        $("#markerTI4").removeClass("danger")
        $("#markerTI4").removeClass("noData")
        $("#markerTI4").addClass("normal")
    }
    if(needShowWeatherStationError && !weatherStationError){
